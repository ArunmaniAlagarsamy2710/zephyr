...
{
	const char *const reason_strings[] = {
	...
	if (reason_code < ARRAY_SIZE(reason_strings) && reason_strings[reason_code]) {
		return reason_strings[reason_code];
	}

	return reason_strings[WLAN_REASON_UNKNOWN];
}
